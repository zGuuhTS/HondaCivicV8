...
public final class SplitPairRule extends SplitRule {
    ...
    public SplitPairRule(Set<SplitPairFilter> filters2, boolean finishPrimaryWithSecondary2, boolean finishSecondaryWithPrimary2, boolean clearTop2, int minWidth, int minSmallestWidth, float splitRatio, int layoutDir) {
        super(minWidth, minSmallestWidth, splitRatio, layoutDir);
        Intrinsics.checkNotNullParameter(filters2, "filters");
        this.finishPrimaryWithSecondary = finishPrimaryWithSecondary2;
        this.finishSecondaryWithPrimary = finishSecondaryWithPrimary2;
        this.clearTop = clearTop2;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SplitPairRule) && super.equals(other) && Intrinsics.areEqual((Object) this.filters, (Object) ((SplitPairRule) other).filters) && this.finishPrimaryWithSecondary == ((SplitPairRule) other).finishPrimaryWithSecondary && this.finishSecondaryWithPrimary == ((SplitPairRule) other).finishSecondaryWithPrimary && this.clearTop == ((SplitPairRule) other).clearTop) {
            return true;
        }
        return false;
    }
