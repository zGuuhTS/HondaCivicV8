...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mLayoutResId = C0100R.C0103layout.preference;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0100R.styleable.Preference, defStyleAttr, defStyleRes);
        this.mIconResId = TypedArrayUtils.getResourceId(a, C0100R.styleable.Preference_icon, C0100R.styleable.Preference_android_icon, 0);
        this.mKey = TypedArrayUtils.getString(a, C0100R.styleable.Preference_key, C0100R.styleable.Preference_android_key);
        this.mTitle = TypedArrayUtils.getText(a, C0100R.styleable.Preference_title, C0100R.styleable.Preference_android_title);
        this.mSummary = TypedArrayUtils.getText(a, C0100R.styleable.Preference_summary, C0100R.styleable.Preference_android_summary);
        this.mOrder = TypedArrayUtils.getInt(a, C0100R.styleable.Preference_order, C0100R.styleable.Preference_android_order, Integer.MAX_VALUE);
        this.mFragment = TypedArrayUtils.getString(a, C0100R.styleable.Preference_fragment, C0100R.styleable.Preference_android_fragment);
        this.mLayoutResId = TypedArrayUtils.getResourceId(a, C0100R.styleable.Preference_layout, C0100R.styleable.Preference_android_layout, C0100R.C0103layout.preference);
        this.mWidgetLayoutResId = TypedArrayUtils.getResourceId(a, C0100R.styleable.Preference_widgetLayout, C0100R.styleable.Preference_android_widgetLayout, 0);
        this.mEnabled = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_enabled, C0100R.styleable.Preference_android_enabled, true);
        this.mSelectable = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_selectable, C0100R.styleable.Preference_android_selectable, true);
        this.mPersistent = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_persistent, C0100R.styleable.Preference_android_persistent, true);
        this.mDependencyKey = TypedArrayUtils.getString(a, C0100R.styleable.Preference_dependency, C0100R.styleable.Preference_android_dependency);
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_allowDividerAbove, C0100R.styleable.Preference_allowDividerAbove, this.mSelectable);
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_allowDividerBelow, C0100R.styleable.Preference_allowDividerBelow, this.mSelectable);
        if (a.hasValue(C0100R.styleable.Preference_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(a, C0100R.styleable.Preference_defaultValue);
        } else if (a.hasValue(C0100R.styleable.Preference_android_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(a, C0100R.styleable.Preference_android_defaultValue);
        }
        this.mShouldDisableView = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_shouldDisableView, C0100R.styleable.Preference_android_shouldDisableView, true);
        boolean hasValue = a.hasValue(C0100R.styleable.Preference_singleLineTitle);
        this.mHasSingleLineTitleAttr = hasValue;
        if (hasValue) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_singleLineTitle, C0100R.styleable.Preference_android_singleLineTitle, true);
        }
        this.mIconSpaceReserved = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_iconSpaceReserved, C0100R.styleable.Preference_android_iconSpaceReserved, false);
        this.mVisible = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_isPreferenceVisible, C0100R.styleable.Preference_isPreferenceVisible, true);
        this.mCopyingEnabled = TypedArrayUtils.getBoolean(a, C0100R.styleable.Preference_enableCopying, C0100R.styleable.Preference_enableCopying, false);
        a.recycle();
    }
    ...
    public Preference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, C0100R.attr.preferenceStyle, 16842894));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View imageFrame = holder.findViewById(C0100R.C0102id.icon_frame);
        if (imageFrame == null) {
    ...
    /* access modifiers changed from: protected */
    public <T extends Preference> T findPreferenceInHierarchy(String key) {
        PreferenceManager preferenceManager = this.mPreferenceManager;
        if (preferenceManager == null) {
            return null;
        }
    ...
    private static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            if (this.mPreference.isCopyingEnabled() && !TextUtils.isEmpty(summary)) {
                ...
                menu.add(0, 0, 0, C0100R.string.copy).setOnMenuItemClickListener(this);
            }
        }
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            Toast.makeText(this.mPreference.getContext(), this.mPreference.getContext().getString(C0100R.string.preference_copied, new Object[]{summary}), 0).show();
            return true;
        }
    }
}
