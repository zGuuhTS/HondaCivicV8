...
public final class C0762x739755bf implements FlowCollector<T> {
    final /* synthetic */ ProducerScope $$this$broadcast$inlined;

    public C0762x739755bf(ProducerScope producerScope) {
    ...
    public Object emit(T value, Continuation<? super Unit> $completion) {
        ...
        Object send = this.$$this$broadcast$inlined.send(value, $completion);
