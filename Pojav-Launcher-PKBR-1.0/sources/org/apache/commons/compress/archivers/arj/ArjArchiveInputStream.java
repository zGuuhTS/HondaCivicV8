...
public class ArjArchiveInputStream extends ArchiveInputStream {
    ...
    /* renamed from: in */
    private final DataInputStream f138in;
    ...
    public ArjArchiveInputStream(InputStream inputStream, String str) throws ArchiveException {
        ...
        this.f138in = new DataInputStream(inputStream);
    ...
    private byte[] readHeader() throws IOException {
        ...
        byte[] bArr = null;
        do {
            int read8 = read8(this.f138in);
            while (true) {
                int read82 = read8(this.f138in);
                if (read8 == 96 || read82 == ARJ_MAGIC_2) {
                    int read16 = read16(this.f138in);
                } else {
                    read8 = read82;
                }
            }
            int read162 = read16(this.f138in);
            if (read162 == 0) {
                return null;
            }
            if (read162 <= 2600) {
                bArr = new byte[read162];
                readFully(this.f138in, bArr);
                CRC32 crc32 = new CRC32();
                crc32.update(bArr);
                if ((((long) read32(this.f138in)) & 4294967295L) == crc32.getValue()) {
                    z = true;
                    continue;
                } else {
                    continue;
    ...
    private MainHeader readMainHeader() throws IOException {
        ...
        if (readHeader != null) {
            ...
            if (read16 > 0) {
                ...
                readFully(this.f138in, mainHeader2.extendedHeaderBytes);
                CRC32 crc32 = new CRC32();
    ...
    public ArjArchiveEntry getNextEntry() throws IOException {
        ...
        if (readLocalFileHeader != null) {
            this.currentInputStream = new BoundedInputStream(this.f138in, this.currentLocalFileHeader.compressedSize);
