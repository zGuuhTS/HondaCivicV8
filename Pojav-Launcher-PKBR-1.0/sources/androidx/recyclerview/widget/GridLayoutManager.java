    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (this.mOrientation == 1) {
            if (layoutState2.mLayoutDirection == -1) {
                ...
                top3 = bottom2 - maxSize;
            } else {
                top3 = layoutState2.mOffset;
                bottom2 = top3 + maxSize;
            }
        ...
        while (i6 < itemSpanIndex) {
            ...
            if (this.mOrientation != 1) {
                left = left2;
                right = right2;
                int top4 = getPaddingTop() + this.mCachedBorders[params.mSpanIndex];
                top2 = top4;
                bottom = this.mOrientationHelper.getDecoratedMeasurementInOther(view6) + top4;
            } else if (isLayoutRTL()) {
                int i7 = left2;
                int i8 = right2;
            ...
            layoutDecoratedWithMargins(view6, left, top2, right, bottom);
