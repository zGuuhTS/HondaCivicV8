...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m64constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
    ...
    public static final void postFrameCallback(Choreographer choreographer2, CancellableContinuation<? super Long> cont) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() {
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1549postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m1549postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
