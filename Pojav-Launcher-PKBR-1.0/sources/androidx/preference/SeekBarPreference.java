...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0100R.styleable.SeekBarPreference, defStyleAttr, defStyleRes);
        this.mMin = a.getInt(C0100R.styleable.SeekBarPreference_min, 0);
        setMax(a.getInt(C0100R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(a.getInt(C0100R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = a.getBoolean(C0100R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = a.getBoolean(C0100R.styleable.SeekBarPreference_showSeekBarValue, false);
        this.mUpdatesContinuously = a.getBoolean(C0100R.styleable.SeekBarPreference_updatesContinuously, false);
        a.recycle();
    }
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, C0100R.attr.seekBarPreferenceStyle);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        this.mSeekBar = (SeekBar) holder.findViewById(C0100R.C0102id.seekbar);
        TextView textView = (TextView) holder.findViewById(C0100R.C0102id.seekbar_value);
