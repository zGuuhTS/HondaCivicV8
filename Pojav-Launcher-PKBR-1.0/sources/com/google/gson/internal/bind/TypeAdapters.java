...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r3, com.google.gson.reflect.TypeToken<T> r4) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C072430.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    boolean set = false;
                    switch (C073136.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()]) {
                        case 1:
                            if (in.nextInt() != 0) {
                                set = true;
                                break;
        ...
        C07233 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader in) throws IOException {
        ...
        C07335 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C07346 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C07357 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C070514 r05 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                JsonToken jsonToken = in.peek();
                switch (C073136.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()]) {
                    case 1:
                    case 3:
        ...
        C070615 r06 = new TypeAdapter<Character>() {
        ...
        C070716 r07 = new TypeAdapter<String>() {
        ...
        C071019 r08 = new TypeAdapter<StringBuilder>() {
        ...
        C071220 r09 = new TypeAdapter<StringBuffer>() {
        ...
        C071321 r010 = new TypeAdapter<URL>() {
        ...
        C071422 r011 = new TypeAdapter<URI>() {
        ...
        C071523 r012 = new TypeAdapter<InetAddress>() {
        ...
        C071624 r013 = new TypeAdapter<UUID>() {
        ...
        C072027 r014 = new TypeAdapter<Calendar>() {
        ...
        C072128 r015 = new TypeAdapter<Locale>() {
        ...
        C072229 r016 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader in) throws IOException {
                switch (C073136.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C073136 {
