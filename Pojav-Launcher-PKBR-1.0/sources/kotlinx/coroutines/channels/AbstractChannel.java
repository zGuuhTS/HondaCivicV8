...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.Object m1551receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r7) {
        /*
            r6 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r4 = r4.m1575closedJP2dKIU(r5)
            goto L_0x0056
        L_0x0050:
            kotlinx.coroutines.channels.ChannelResult$Companion r4 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r4 = r4.m1577successJP2dKIU(r1)
        L_0x0056:
            return r4
        L_0x0057:
            r3 = 1
        ...
        L_0x0061:
            ...
            java.lang.Object r1 = r2.m1574unboximpl()
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1551receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object m1552tryReceivePtdJZtk() {
        Object result = pollInternal();
        if (result == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m1576failurePtdJZtk();
        }
        if (result instanceof Closed) {
            return ChannelResult.Companion.m1575closedJP2dKIU(((Closed) result).closeCause);
        }
        return ChannelResult.Companion.m1577successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        if (closed != null) {
            Object list = InlineList.m1599constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode previous = closed.getPrevNode();
                if (previous instanceof LockFreeLinkedListHead) {
                    m1550onCancelIdempotentListww6eGU(list, closed);
                    return;
                    ...
                    list = InlineList.m1604plusFjFbRPM(list, (Send) previous);
                }
            }
        } else {
    ...
    public void m1550onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list != null) {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> $this$tryStartBlockUnintercepted, SelectInstance<? super R> select, int receiveMode, Object value) {
        if (value instanceof Closed) {
            switch (receiveMode) {
                ...
                case 1:
                    if (select.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted($this$tryStartBlockUnintercepted, ChannelResult.m1562boximpl(ChannelResult.Companion.m1575closedJP2dKIU(((Closed) value).closeCause)), select.getCompletion());
                        return;
                    }
                    return;
                default:
            ...
            UndispatchedKt.startCoroutineUnintercepted($this$tryStartBlockUnintercepted, ChannelResult.m1562boximpl($this$toResult$iv instanceof Closed ? ChannelResult.Companion.m1575closedJP2dKIU(((Closed) $this$toResult$iv).closeCause) : ChannelResult.Companion.m1577successJP2dKIU($this$toResult$iv)), select.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (result2 instanceof Closed) {
                    if (((Closed) result2).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m64constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = ((Closed) result2).getReceiveException();
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m64constructorimpl(ResultKt.createFailure(receiveException)));
                    }
                } else if (result2 != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean2 = Boxing.boxBoolean(true);
                    Function1 function1 = this.channel.onUndeliveredElement;
                    cont.resume(boxBoolean2, function1 == null ? null : OnUndeliveredElementKt.bindCancellationFun(function1, result2, cont.getContext()));
                }
            }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            if (this.receiveMode == 1) {
                return ChannelResult.m1562boximpl(ChannelResult.Companion.m1577successJP2dKIU(value));
            }
            return value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ChannelResult r1 = ChannelResult.m1562boximpl(ChannelResult.Companion.m1575closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m64constructorimpl(r1));
                return;
            }
            Throwable receiveException = closed.getReceiveException();
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m64constructorimpl(ResultKt.createFailure(receiveException)));
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1562boximpl(ChannelResult.Companion.m1577successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1562boximpl(ChannelResult.Companion.m1575closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                        return;
                    default:
                        return;
                }
