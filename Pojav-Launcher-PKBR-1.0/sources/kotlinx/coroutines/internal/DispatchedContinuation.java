...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:61:0x012b A[Catch:{ all -> 0x0108, all -> 0x013e }] */
    ...
    public final void resumeCancellableWith(java.lang.Object r24, kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit> r25) {
        ...
        L_0x0059:
            ...
            r0 = r23
            r13 = 0
            kotlin.coroutines.CoroutineContext r15 = r0.getContext()     // Catch:{ all -> 0x0140 }
            kotlinx.coroutines.Job$Key r16 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x0140 }
            r4 = r16
            kotlin.coroutines.CoroutineContext$Key r4 = (kotlin.coroutines.CoroutineContext.Key) r4     // Catch:{ all -> 0x0140 }
            kotlin.coroutines.CoroutineContext$Element r4 = r15.get(r4)     // Catch:{ all -> 0x0140 }
            kotlinx.coroutines.Job r4 = (kotlinx.coroutines.Job) r4     // Catch:{ all -> 0x0140 }
            ...
            r19 = r0
            java.lang.Object r0 = kotlin.Result.m64constructorimpl(r18)     // Catch:{ all -> 0x009f }
        ...
        L_0x00ab:
            ...
            r4 = r23
            r13 = 0
            kotlin.coroutines.Continuation<T> r0 = r4.continuation     // Catch:{ all -> 0x0140 }
            java.lang.Object r14 = r4.countOrElement     // Catch:{ all -> 0x0140 }
            r15 = r0
            r18 = 0
            kotlin.coroutines.CoroutineContext r0 = r15.getContext()     // Catch:{ all -> 0x0140 }
            r19 = r0
            r1 = r19
            java.lang.Object r0 = kotlinx.coroutines.internal.ThreadContextKt.updateThreadContext(r1, r14)     // Catch:{ all -> 0x0140 }
            r19 = r0
            kotlinx.coroutines.internal.Symbol r0 = kotlinx.coroutines.internal.ThreadContextKt.NO_THREAD_ELEMENTS     // Catch:{ all -> 0x0140 }
            r20 = r2
            r2 = r19
        ...
        L_0x00d9:
            r16 = 0
            r0 = r16
            kotlinx.coroutines.UndispatchedCoroutine r0 = (kotlinx.coroutines.UndispatchedCoroutine) r0     // Catch:{ all -> 0x0125 }
        L_0x00df:
            r19 = r0
            r0 = 0
            r21 = r0
            kotlin.coroutines.Continuation<T> r0 = r4.continuation     // Catch:{ all -> 0x010a }
            r22 = r3
            r3 = r24
            r0.resumeWith(r3)     // Catch:{ all -> 0x0108 }
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0108 }
            r17 = 1
            kotlin.jvm.internal.InlineMarker.finallyStart(r17)     // Catch:{ all -> 0x013e }
            if (r19 == 0) goto L_0x00fe
            boolean r0 = r19.clearThreadContext()     // Catch:{ all -> 0x013e }
            if (r0 == 0) goto L_0x0101
        L_0x00fe:
            kotlinx.coroutines.internal.ThreadContextKt.restoreThreadContext(r1, r2)     // Catch:{ all -> 0x013e }
        L_0x0101:
            r17 = 1
            kotlin.jvm.internal.InlineMarker.finallyEnd(r17)     // Catch:{ all -> 0x013e }
            goto L_0x0131
        L_0x0108:
            r0 = move-exception
            goto L_0x010f
        ...
        L_0x010f:
            ...
            boolean r21 = r19.clearThreadContext()     // Catch:{ all -> 0x013e }
        ...
        L_0x0131:
        L_0x0132:
            boolean r0 = r9.processUnconfinedEvent()     // Catch:{ all -> 0x013e }
        ...
        L_0x0147:
            r1 = 0
            r10.handleFatalException(r0, r1)     // Catch:{ all -> 0x015a }
            r1 = 1
            kotlin.jvm.internal.InlineMarker.finallyStart(r1)
        L_0x014f:
