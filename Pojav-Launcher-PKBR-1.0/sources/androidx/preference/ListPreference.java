...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0100R.styleable.ListPreference, defStyleAttr, defStyleRes);
        this.mEntries = TypedArrayUtils.getTextArray(a, C0100R.styleable.ListPreference_entries, C0100R.styleable.ListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(a, C0100R.styleable.ListPreference_entryValues, C0100R.styleable.ListPreference_android_entryValues);
        if (TypedArrayUtils.getBoolean(a, C0100R.styleable.ListPreference_useSimpleSummaryProvider, C0100R.styleable.ListPreference_useSimpleSummaryProvider, false)) {
            setSummaryProvider(SimpleSummaryProvider.getInstance());
        }
        a.recycle();
        TypedArray a2 = context.obtainStyledAttributes(attrs, C0100R.styleable.Preference, defStyleAttr, defStyleRes);
        this.mSummary = TypedArrayUtils.getString(a2, C0100R.styleable.Preference_summary, C0100R.styleable.Preference_android_summary);
        a2.recycle();
    }
    ...
    public static final class SimpleSummaryProvider implements Preference.SummaryProvider<ListPreference> {
        ...
        public CharSequence provideSummary(ListPreference preference) {
            if (TextUtils.isEmpty(preference.getEntry())) {
                return preference.getContext().getString(C0100R.string.not_set);
            }
