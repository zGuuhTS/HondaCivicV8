...
public final class FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        ...
        Continuation<? super Unit> continuation2 = $completion;
        Flow prepared = FlowKt__ContextKt.buffer$default(FlowKt.flowOn(this.$source$inlined, $completion.getContext().minusKey(Job.Key)), this.$bufferSize$inlined, (BufferOverflow) null, 2, (Object) null);
        Object collect = FlowKt__ContextKt.buffer$default(FlowKt.flowOn((Flow) this.$builder$inlined.invoke(prepared), this.$flowContext$inlined), this.$bufferSize$inlined, (BufferOverflow) null, 2, (Object) null).collect(new FlowKt__ContextKt$flowWith$lambda3$$inlined$collect$1(collector), $completion);
