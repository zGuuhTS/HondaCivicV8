...
public final class ContentInfoCompat {
    ...
    public String toString() {
        StringBuilder append = new StringBuilder().append("ContentInfoCompat{clip=").append(this.mClip.getDescription()).append(", source=").append(sourceToString(this.mSource)).append(", flags=").append(flagsToString(this.mFlags));
        Uri uri = this.mLinkUri;
        String str = BuildConfig.FLAVOR;
        StringBuilder append2 = append.append(uri == null ? str : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")");
