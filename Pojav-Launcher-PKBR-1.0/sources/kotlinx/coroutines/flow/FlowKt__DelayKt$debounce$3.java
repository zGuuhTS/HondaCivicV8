...
@Metadata(mo11814d1 = {"\u0000\n\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\n"}, mo11815d2 = {"<anonymous>", "", "T", "emittedItem"}, mo11816k = 3, mo11817mv = {1, 5, 1}, mo11819xi = 48)
...
final class FlowKt__DelayKt$debounce$3 extends Lambda implements Function1<T, Long> {
    ...
    public final Long invoke(T emittedItem) {
        return Long.valueOf(DelayKt.m1544toDelayMillisLRDsOJo(this.$timeout.invoke(emittedItem).m1429unboximpl()));
    }
}
