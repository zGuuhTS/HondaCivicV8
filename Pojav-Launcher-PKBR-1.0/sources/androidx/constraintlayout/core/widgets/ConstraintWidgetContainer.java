...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public void addVerticalWrapMinVariable(ConstraintAnchor top2) {
        WeakReference<ConstraintAnchor> weakReference = this.verticalWrapMin;
        if (weakReference == null || weakReference.get() == null || top2.getFinalValue() > ((ConstraintAnchor) this.verticalWrapMin.get()).getFinalValue()) {
            this.verticalWrapMin = new WeakReference<>(top2);
        }
    }
