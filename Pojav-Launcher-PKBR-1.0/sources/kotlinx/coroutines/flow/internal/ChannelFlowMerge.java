...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(ProducerScope<? super T> scope, Continuation<? super Unit> $completion) {
        Object collect = this.flow.collect(new ChannelFlowMerge$collectTo$$inlined$collect$1((Job) $completion.getContext().get(Job.Key), SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, (Object) null), scope, new SendingCollector(scope)), $completion);
