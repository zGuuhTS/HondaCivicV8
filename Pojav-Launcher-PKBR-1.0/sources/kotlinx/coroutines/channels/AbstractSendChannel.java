...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object m1553trySendJP2dKIU(E element) {
        ...
        if (result == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m1575closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (result instanceof Closed) {
            return ChannelResult.Companion.m1575closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> $this$helpCloseAndResumeWithSendException, E element, Closed<?> closed) {
        ...
        if (function1 == null || (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, element, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            Result.Companion companion = Result.Companion;
            $this$helpCloseAndResumeWithSendException.resumeWith(Result.m64constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        ExceptionsKt.addSuppressed(it, sendException);
        Result.Companion companion2 = Result.Companion;
        $this$helpCloseAndResumeWithSendException.resumeWith(Result.m64constructorimpl(ResultKt.createFailure(it)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1599constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (previous == null) {
                ...
                closedList = InlineList.m1604plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
    ...
    @Metadata(mo11814d1 = {"\u00006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u00030\u0002j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u0003`\u0004B\u0015\u0012\u0006\u0010\u0005\u001a\u00028\u0001\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0012\u0010\n\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0014J\u0016\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\n\u0010\u000f\u001a\u00060\u0010j\u0002`\u0011H\u0016R\u0012\u0010\u0005\u001a\u00028\u00018\u0006X\u0004¢\u0006\u0004\n\u0002\u0010\t¨\u0006\u0012"}, mo11815d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$TryOfferDesc;", "E", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/ReceiveOrClosed;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "element", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Ljava/lang/Object;Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "Ljava/lang/Object;", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, mo11816k = 1, mo11817mv = {1, 5, 1}, mo11819xi = 48)
    /* compiled from: AbstractChannel.kt */
