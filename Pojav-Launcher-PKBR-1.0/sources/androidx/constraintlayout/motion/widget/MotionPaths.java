...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f73x;
        float position3 = position2;
        float position4 = motionPaths.f74y;
        float endCenterX = motionPaths2.f73x + (f / 2.0f);
        float endCenterY = motionPaths2.f74y + (f3 / 2.0f);
        float pathVectorX = endCenterX - (f5 + (f2 / 2.0f));
        float pathVectorY = endCenterY - (position4 + (f4 / 2.0f));
        this.f73x = (float) ((int) ((f5 + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f74y = (float) ((int) ((position4 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        ...
        this.mMode = 0;
        this.f73x = (float) ((int) (((motionPaths.f73x + (pathVectorX * dxdx)) + (pathVectorY * dxdy)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f74y = (float) ((int) (((motionPaths.f74y + (pathVectorX * dydx)) + (pathVectorY * dydy)) - ((scaleY * scaleHeight) / 2.0f)));
    ...
    public void setupRelative(MotionController mc, MotionPaths relative) {
        double dx = (double) (((this.f73x + (this.width / 2.0f)) - relative.f73x) - (relative.width / 2.0f));
        double dy = (double) (((this.f74y + (this.height / 2.0f)) - relative.f74y) - (relative.height / 2.0f));
        this.mRelativeToController = mc;
        this.f73x = (float) Math.hypot(dy, dx);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f74y = (float) (Math.atan2(dy, dx) + 1.5707963267948966d);
        } else {
            this.f74y = (float) Math.toRadians((double) this.mRelativeAngle);
        }
    }
    ...
    public void initScreen(int parentWidth, int parentHeight, KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f73x;
        float f6 = position2;
        float position3 = motionPaths.f74y;
        float endCenterX = motionPaths2.f73x + (f / 2.0f);
        float endCenterY = motionPaths2.f74y + (f3 / 2.0f);
        this.f73x = (float) ((int) ((f5 + ((endCenterX - (f5 + (f2 / 2.0f))) * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f74y = (float) ((int) ((position3 + ((endCenterY - (position3 + (f4 / 2.0f))) * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        this.height = (float) ((int) (f4 + (scaleY * scaleHeight)));
        this.mMode = 2;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f73x = (float) ((int) (keyPosition.mPercentX * ((float) ((int) (((float) parentWidth) - this.width)))));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f74y = (float) ((int) (keyPosition.mPercentY * ((float) ((int) (((float) parentHeight) - this.height)))));
        }
    ...
    public void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f = motionPaths.f73x;
        float f2 = motionPaths.width;
        float f3 = motionPaths.f74y;
        float f4 = position2;
        float position3 = motionPaths.height;
        float endCenterX = motionPaths2.f73x + (motionPaths2.width / 2.0f);
        float endCenterY = motionPaths2.f74y + (motionPaths2.height / 2.0f);
        float pathVectorX = endCenterX - ((f2 / 2.0f) + f);
        float pathVectorY = endCenterY - (f3 + (position3 / 2.0f));
        this.f73x = (float) ((int) ((f + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f74y = (float) ((int) ((f3 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        ...
        float f6 = endCenterY;
        float f7 = (float) ((int) ((motionPaths3.f73x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f73x = f7;
        float f8 = pathVectorX;
        float f9 = (float) ((int) ((motionPaths3.f74y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.f74y = f9;
        this.f73x = f7 + ((-pathVectorY) * perpendicular);
        this.f74y = f9 + (pathVectorX * perpendicular);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
    ...
    public void different(MotionPaths points, boolean[] mask, String[] custom, boolean arcMode) {
        boolean diffx = diff(this.f73x, points.f73x);
        boolean diffy = diff(this.f74y, points.f74y);
        int c = 0 + 1;
    ...
    public void setView(float position2, View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        ...
        int[] iArr = toUse;
        double[] dArr = slope;
        float v_x2 = this.f73x;
        float v_y2 = this.f74y;
        float v_width = this.width;
        ...
        while (true) {
            ...
            if (i2 < dArr2.length) {
                ...
                if (motionController != null) {
                    ...
                    float dangle3 = dangle2;
                    dangle = v_width3;
                    float dpos_x = (float) (((double) drx) + (((double) dradius2) * Math.sin((double) rx2)) + (((double) radius) * Math.cos((double) rx2) * ((double) dangle3)));
                    float f9 = dradius2;
    ...
    public void fillStandard(double[] data, int[] toUse) {
        float[] set = {this.position, this.f73x, this.f74y, this.width, this.height, this.mPathRotate};
        int c = 0;
        for (int i = 0; i < toUse.length; i++) {
