        ...
        if (newLengthHint >= 0) {
            ...
            do {
                ...
                if (occurrenceIndex >= $this$replace_u24lambda_u2d2.length() || (occurrenceIndex = StringsKt.indexOf((CharSequence) $this$replace_u24lambda_u2d2, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0) {
                    String sb = stringBuilder.append($this$replace_u24lambda_u2d2, i, $this$replace_u24lambda_u2d2.length()).toString();
            ...
            String sb2 = stringBuilder.append($this$replace_u24lambda_u2d2, i, $this$replace_u24lambda_u2d2.length()).toString();
