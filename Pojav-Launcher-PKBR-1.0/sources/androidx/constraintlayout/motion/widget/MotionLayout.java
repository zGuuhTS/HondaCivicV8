...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState newState) {
        if (newState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            switch (C03085.f71xabc7e4ac[oldState.ordinal()]) {
                case 1:
                case 2:
    ...
    static /* synthetic */ class C03085 {
        ...
        static {
            ...
            try {
                f71xabc7e4ac[TransitionState.SETUP.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f71xabc7e4ac[TransitionState.MOVING.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f71xabc7e4ac[TransitionState.FINISHED.ordinal()] = 4;
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f72me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f72me.tracker = VelocityTracker.obtain();
            return f72me;
        }
    ...
    class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String str2 = "_";
                StringBuilder append = new StringBuilder().append(((BuildConfig.FLAVOR + (child.mTop.mTarget != null ? "T" : str2)) + (child.mBottom.mTarget != null ? "B" : str2)) + (child.mLeft.mTarget != null ? "L" : str2));
                if (child.mRight.mTarget != null) {
                    str2 = "R";
                }
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x, float y) {
            ...
            String text = BuildConfig.FLAVOR + (((float) ((int) ((len * 100.0f) / dist))) / 100.0f);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = BuildConfig.FLAVOR + (((float) ((int) (((double) ((xgap * 100.0f) / Math.abs(x2 - x1))) + 0.5d))) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = str2 + (((float) ((int) (((double) ((ygap * 100.0f) / Math.abs(y2 - y1))) + 0.5d))) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            ...
            float xgap = x;
            float ygap = y;
            String text = BuildConfig.FLAVOR + (((float) ((int) (((double) (((xgap - ((float) (viewWidth / 2))) * 100.0f) / ((float) (MotionLayout.this.getWidth() - viewWidth)))) + 0.5d))) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String str2 = BuildConfig.FLAVOR;
            canvas.drawLine(x, y, min, y, paint);
            String text2 = str2 + (((float) ((int) (((double) (((ygap - ((float) (viewHeight / 2))) * 100.0f) / ((float) (MotionLayout.this.getHeight() - viewHeight)))) + 0.5d))) / 100.0f);
            getTextBounds(text2, this.mTextPaint);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0052R.styleable.MotionLayout);
            int N = a.getIndexCount();
            boolean apply = true;
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0052R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, a.getResourceId(attr, -1));
                } else if (attr == C0052R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = a.getResourceId(attr, -1);
                } else if (attr == C0052R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = a.getFloat(attr, 0.0f);
                    this.mInTransition = true;
                } else if (attr == C0052R.styleable.MotionLayout_applyMotionScene) {
                    apply = a.getBoolean(attr, apply);
                } else {
                    int i2 = 0;
                    if (attr == C0052R.styleable.MotionLayout_showPaths) {
                    ...
                    } else if (attr == C0052R.styleable.MotionLayout_motionDebug) {
    ...
    public void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        if (v == null) {
            idName = BuildConfig.FLAVOR + mTouchAnchorId;
        } else {
    ...
    public void updateStateAnimate(int stateId, ConstraintSet set, int duration) {
        if (this.mScene != null && this.mCurrentState == stateId) {
            updateState(C0052R.C0054id.view_transition, getConstraintSet(stateId));
            setState(C0052R.C0054id.view_transition, -1, -1);
            updateState(stateId, set);
            MotionScene.Transition tmpTransition = new MotionScene.Transition(-1, this.mScene, C0052R.C0054id.view_transition, stateId);
