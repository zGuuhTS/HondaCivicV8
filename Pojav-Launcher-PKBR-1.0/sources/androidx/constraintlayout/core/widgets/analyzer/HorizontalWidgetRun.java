...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C02971 {
        ...
        static final /* synthetic */ int[] f64x56910102;
        ...
        static {
            ...
            try {
                f64x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f64x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        switch (C02971.f64x56910102[this.mRunType.ordinal()]) {
            case 1:
