...
import androidx.recyclerview.C0104R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0104R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C0104R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0104R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C0104R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C0104R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0104R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = a.getBoolean(C0104R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C0104R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0104R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0104R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0104R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? AWTInputEvent.VK_DEAD_CIRCUMFLEX : 33;
    ...
    private boolean isPreferredNextFocus(View focused, View next, int direction) {
        ...
        switch (direction) {
            ...
            case 66:
                ...
                return false;
            case AWTInputEvent.VK_DEAD_CIRCUMFLEX:
                if (downness > 0) {
                    return true;
                }
                return false;
    ...
    public void repositionShadowingViews() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!(holder == null || holder.mShadowingHolder == null)) {
                ...
                if (left != shadowingView.getLeft() || top2 != shadowingView.getTop()) {
                    shadowingView.layout(left, top2, shadowingView.getWidth() + left, shadowingView.getHeight() + top2);
                }
            }
        }
    }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH holder, int position) {
            ...
            holder.setFlags(1, AWTInputEvent.VK_LEFT_PARENTHESIS);
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C05601 r0 = new ViewBoundsCheck.Callback() {
            ...
            C05612 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int index) {
                    return LayoutManager.this.getChildAt(index);
                }
        ...
        public void layoutDecorated(View child, int left, int top2, int right, int bottom) {
            Rect insets = ((LayoutParams) child.getLayoutParams()).mDecorInsets;
            child.layout(insets.left + left, insets.top + top2, right - insets.right, bottom - insets.bottom);
        }

        public void layoutDecoratedWithMargins(View child, int left, int top2, int right, int bottom) {
            LayoutParams lp = (LayoutParams) child.getLayoutParams();
            Rect insets = lp.mDecorInsets;
            child.layout(insets.left + left + lp.leftMargin, insets.top + top2 + lp.topMargin, (right - insets.right) - lp.rightMargin, (bottom - insets.bottom) - lp.bottomMargin);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0104R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0104R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0104R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0104R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0104R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(AWTInputEvent.VK_WINDOWS) || !viewHolder.isBound()) {
            return -1;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0104R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0104R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0104R.dimen.fastscroll_margin));
    }
