...
public final class CombineKt$zipImpl$1$1$2$invokeSuspend$$inlined$collect$1 implements FlowCollector<T1> {
    ...
    public Object emit(T1 value, Continuation<? super Unit> $completion) {
        Continuation<? super Unit> continuation = $completion;
        Object withContextUndispatched = ChannelFlowKt.withContextUndispatched(this.$scopeContext$inlined, Unit.INSTANCE, this.$cnt$inlined, new CombineKt$zipImpl$1$1$2$1$1(this.$second$inlined, this.$this_unsafeFlow$inlined, this.$transform$inlined, value, (Continuation<? super CombineKt$zipImpl$1$1$2$1$1>) null), $completion);
