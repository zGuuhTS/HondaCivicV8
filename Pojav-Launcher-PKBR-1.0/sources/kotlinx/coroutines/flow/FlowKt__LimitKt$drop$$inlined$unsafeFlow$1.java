...
public final class FlowKt__LimitKt$drop$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
        ...
        Object collect = this.$this_drop$inlined.collect(new FlowKt__LimitKt$drop$lambda2$$inlined$collect$1(new Ref.IntRef(), this.$count$inlined, collector), $completion);
