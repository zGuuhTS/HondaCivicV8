...
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    private int mLayoutResId = C0100R.C0103layout.preference_list_fragment;
    RecyclerView mList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requireContext().getTheme().resolveAttribute(C0100R.attr.preferenceTheme, tv, true);
        int theme = tv.resourceId;
        if (theme == 0) {
            theme = C0100R.style.PreferenceThemeOverlay;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = requireContext().obtainStyledAttributes((AttributeSet) null, C0100R.styleable.PreferenceFragmentCompat, C0100R.attr.preferenceFragmentCompatStyle, 0);
        this.mLayoutResId = a.getResourceId(C0100R.styleable.PreferenceFragmentCompat_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(C0100R.styleable.PreferenceFragmentCompat_android_divider);
        int dividerHeight = a.getDimensionPixelSize(C0100R.styleable.PreferenceFragmentCompat_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(C0100R.styleable.PreferenceFragmentCompat_allowDividerAfterLastItem, true);
        a.recycle();
    ...
    public void setPreferencesFromResource(int r6, java.lang.String r7) {
        /*
            r5 = this;
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        fragmentManager.beginTransaction().replace(((View) requireView().getParent()).getId(), fragment).addToBackStack((String) null).commit();
        return true;
    }
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        if (requireContext().getPackageManager().hasSystemFeature("android.hardware.type.automotive") && (recyclerView = (RecyclerView) parent.findViewById(C0100R.C0102id.recycler_view)) != null) {
            return recyclerView;
        }
        RecyclerView recyclerView2 = (RecyclerView) inflater.inflate(C0100R.C0103layout.preference_recyclerview, parent, false);
            ...
            if (this.mDivider != null) {
                ...
                for (int childViewIndex = 0; childViewIndex < childCount; childViewIndex++) {
                    ...
                    if (shouldDrawDividerBelow(view, parent)) {
                        int top2 = ((int) view.getY()) + view.getHeight();
                        this.mDivider.setBounds(0, top2, width, this.mDividerHeight + top2);
