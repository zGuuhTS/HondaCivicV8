...
public class ConstraintWidget {
    ...
    public void setFinalFrame(int left, int top2, int right, int bottom, int baseline, int orientation) {
        setFrame(left, top2, right, bottom);
    ...
    public void setDebugSolverName(LinearSystem system, String name) {
        ...
        SolverVariable top2 = system.createObjectVariable(this.mTop);
    ...
    public String toString() {
        ...
        return append.append(str2).append("(").append(this.f57mX).append(", ").append(this.f58mY).append(") - (").append(this.mWidth).append(" x ").append(this.mHeight).append(")").toString();
    }
    ...
    public int getX() {
        ...
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f57mX;
    }
    ...
    public int getY() {
        ...
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f58mY;
    }
    ...
    /* access modifiers changed from: protected */
    public int getRootX() {
        return this.f57mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f58mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int goneMargin) {
        switch (C02951.f59x6930e354[type.ordinal()]) {
            case 1:
    ...
    public void setFrame(int left, int top2, int right, int bottom) {
        int w = right - left;
        int h = bottom - top2;
        this.f57mX = left;
        this.f58mY = top2;
    ...
    public void setVerticalDimension(int top2, int bottom) {
        this.f58mY = top2;
        int i = bottom - top2;
        this.mHeight = i;
        int i2 = this.mMinHeight;
    ...
    public void connect(ConstraintAnchor.Type constraintFrom, ConstraintWidget target, ConstraintAnchor.Type constraintTo, int margin) {
        if (constraintFrom == ConstraintAnchor.Type.CENTER) {
            if (constraintTo == ConstraintAnchor.Type.CENTER) {
                ...
                if ((top2 == null || !top2.isConnected()) && (bottom == null || !bottom.isConnected())) {
    ...
    public void resetAnchor(ConstraintAnchor anchor) {
        if (getParent() == null || !(getParent() instanceof ConstraintWidgetContainer) || !((ConstraintWidgetContainer) getParent()).handlesInternalConstraints()) {
            ...
            if (anchor == center) {
                ...
                if (top2.isConnected() && bottom.isConnected() && top2.getTarget() == bottom.getTarget()) {
                    top2.reset();
                    bottom.reset();
                }
                ...
                if (top2.isConnected() && bottom.isConnected() && top2.getTarget().getOwner() == bottom.getTarget().getOwner()) {
                    top2.reset();
                    bottom.reset();
                }
                this.mVerticalBiasPercent = 0.5f;
            ...
            } else if ((anchor == top2 || anchor == bottom) && top2.isConnected() && top2.getTarget() == bottom.getTarget()) {
                center.reset();
            }
            anchor.reset();
        }
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C02951.f59x6930e354[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:266:0x060d, code lost:
        if ((r3 instanceof androidx.constraintlayout.core.widgets.Barrier) != false) goto L_0x0612;
     */
    /* JADX WARNING: Removed duplicated region for block: B:243:0x0597  */
    /* JADX WARNING: Removed duplicated region for block: B:253:0x05de  */
    /* JADX WARNING: Removed duplicated region for block: B:258:0x05fc A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:259:0x05fd  */
    /* JADX WARNING: Removed duplicated region for block: B:334:0x06dc A[ADDED_TO_REGION] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void applyConstraints(androidx.constraintlayout.core.LinearSystem r38, boolean r39, boolean r40, boolean r41, boolean r42, androidx.constraintlayout.core.SolverVariable r43, androidx.constraintlayout.core.SolverVariable r44, androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour r45, boolean r46, androidx.constraintlayout.core.widgets.ConstraintAnchor r47, androidx.constraintlayout.core.widgets.ConstraintAnchor r48, int r49, int r50, int r51, int r52, float r53, boolean r54, boolean r55, boolean r56, boolean r57, boolean r58, int r59, int r60, int r61, int r62, float r63, boolean r64) {
        ...
        L_0x0069:
            r14 = r59
        L_0x006b:
            int[] r17 = androidx.constraintlayout.core.widgets.ConstraintWidget.C02951.f60x6d00e4a2
            int r18 = r45.ordinal()
            r17 = r17[r18]
            switch(r17) {
        ...
        L_0x0460:
            ...
            r3 = 1
            r24 = 1
            if (r54 == 0) goto L_0x0494
            r42 = r2
            r61 = r11
            r35 = r27
            r2 = 2
            r11 = r60
            if (r11 == r2) goto L_0x0478
            r2 = 1
            if (r11 != r2) goto L_0x0475
            goto L_0x0478
        L_0x0475:
            r17 = 0
            goto L_0x047a
        ...
        L_0x04b4:
            ...
            goto L_0x057f
        L_0x04ce:
            if (r4 == r12) goto L_0x04d6
            if (r1 == r12) goto L_0x04d6
            r2 = 4
            r25 = r2
            goto L_0x04d9
        L_0x04d6:
        ...
        L_0x057f:
            ...
            if (r15 != r12) goto L_0x058f
            r7 = r50
            r8 = r29
            if (r8 == r7) goto L_0x0593
            r2 = 0
            r23 = 0
            r22 = r2
            goto L_0x0595
        ...
        L_0x0595:
            ...
            if (r55 != 0) goto L_0x05b3
            if (r57 != 0) goto L_0x05b3
            r6 = r11
            r11 = r43
            if (r15 != r11) goto L_0x05b6
            if (r12 != r9) goto L_0x05b6
            r1 = 8
            r2 = 8
            r3 = 0
            r4 = 0
        ...
        L_0x05ec:
            ...
            return
        L_0x05fd:
            if (r22 == 0) goto L_0x062c
            if (r23 == 0) goto L_0x0614
            if (r15 == r12) goto L_0x0614
        ...
        L_0x0649:
            ...
            r5 = r31
        L_0x064d:
            if (r25 == 0) goto L_0x0692
            if (r24 == 0) goto L_0x0674
            if (r57 == 0) goto L_0x0655
            if (r41 == 0) goto L_0x0674
        L_0x0655:
            r7 = r5
            if (r2 == r13) goto L_0x065a
            if (r3 != r13) goto L_0x065b
        L_0x065a:
            r7 = 6
        L_0x065b:
        ...
        L_0x066c:
            r7 = 5
        L_0x066d:
            if (r57 == 0) goto L_0x0670
            r7 = 5
        L_0x0670:
            int r5 = java.lang.Math.max(r7, r5)
        L_0x0674:
            if (r23 == 0) goto L_0x0683
            int r5 = java.lang.Math.min(r4, r5)
            if (r54 == 0) goto L_0x0683
            if (r57 != 0) goto L_0x0683
            if (r2 == r13) goto L_0x0682
            if (r3 != r13) goto L_0x0683
        L_0x0682:
            r5 = 4
        L_0x0683:
        ...
        L_0x0692:
            if (r23 == 0) goto L_0x06a0
            r7 = 0
            if (r11 != r15) goto L_0x069b
            int r7 = r47.getMargin()
        L_0x069b:
            if (r15 == r11) goto L_0x06a0
            r10.addGreaterThan(r6, r11, r7, r14)
        L_0x06a0:
            if (r23 == 0) goto L_0x06c3
            if (r20 == 0) goto L_0x06c3
            r7 = r15
            if (r51 != 0) goto L_0x06c0
            if (r18 != 0) goto L_0x06c0
            if (r20 == 0) goto L_0x06b9
            r8 = r61
            r9 = 3
            if (r8 != r9) goto L_0x06b7
            r9 = 0
            r15 = 8
        ...
        L_0x06d8:
            r23 = r40
        L_0x06da:
            if (r23 == 0) goto L_0x0709
            if (r50 == 0) goto L_0x0709
            r2 = 0
            r3 = r48
        ...
        L_0x0724:
            r5 = r35
            r9 = 2
            if (r5 >= r9) goto L_0x076f
            if (r40 == 0) goto L_0x076f
            if (r50 == 0) goto L_0x076f
            r9 = 8
            r10.addGreaterThan(r6, r11, r2, r9)
            if (r39 != 0) goto L_0x073d
    ...
    static /* synthetic */ class C02951 {
        ...
        static {
            ...
            try {
                f60x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f60x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f60x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f59x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f59x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void updateFromSolver(LinearSystem system, boolean optimize) {
        ...
        int top2 = system.getObjectVariableValue(this.mTop);
        ...
        if (optimize && (verticalWidgetRun = this.verticalRun) != null && verticalWidgetRun.start.resolved && this.verticalRun.end.resolved) {
            top2 = this.verticalRun.start.value;
            bottom = this.verticalRun.end.value;
        }
        int h = bottom - top2;
        if (right - left < 0 || h < 0 || left == Integer.MIN_VALUE || left == Integer.MAX_VALUE || top2 == Integer.MIN_VALUE || top2 == Integer.MAX_VALUE || right == Integer.MIN_VALUE || right == Integer.MAX_VALUE || bottom == Integer.MIN_VALUE || bottom == Integer.MAX_VALUE) {
            left = 0;
            top2 = 0;
            right = 0;
            bottom = 0;
    ...
    public void copy(ConstraintWidget src, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f57mX = src.f57mX;
        this.f58mY = src.f58mY;
    ...
    public void updateFromRuns(boolean updateHorizontal, boolean updateVertical) {
        ...
        int top2 = this.verticalRun.start.value;
    ...
    public void getSceneString(StringBuilder ret) {
        ...
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
        ret.append("    actualLeft:" + this.f57mX);
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
        ret.append("    actualTop:" + this.f58mY);
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
