...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0042R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0042R.styleable.LinearLayoutCompat, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int index = a.getInt(C0042R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0042R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0042R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0042R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0042R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0042R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0042R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0042R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0042R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    /* access modifiers changed from: package-private */
    public void drawHorizontalDivider(Canvas canvas, int top2) {
        this.mDivider.setBounds(getPaddingLeft() + this.mDividerPadding, top2, (getWidth() - getPaddingRight()) - this.mDividerPadding, this.mDividerHeight + top2);
    ...
    /* access modifiers changed from: package-private */
    public void layoutVertical(int left, int top2, int right, int bottom) {
        int childTop;
        int paddingLeft;
        int gravity;
        int childLeft;
        ...
        switch (majorGravity) {
            case 16:
                childTop = getPaddingTop() + (((bottom - top2) - this.mTotalLength) / 2);
                break;
            case 80:
                childTop = ((getPaddingTop() + bottom) - top2) - this.mTotalLength;
                break;
            default:
    ...
    private void setChildFrame(View child, int left, int top2, int width, int height) {
        child.layout(left, top2, left + width, top2 + height);
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0042R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0042R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0042R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
