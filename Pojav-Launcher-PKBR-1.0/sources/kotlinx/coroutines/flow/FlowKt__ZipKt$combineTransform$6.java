...
@DebugMetadata(mo12529c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo12530f = "Zip.kt", mo12531i = {}, mo12532l = {251}, mo12533m = "invokeSuspend", mo12534n = {}, mo12535s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo12529c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo12530f = "Zip.kt", mo12531i = {}, mo12532l = {251}, mo12533m = "invokeSuspend", mo12534n = {}, mo12535s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C08312 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C08312 r0 = new C08312(r4, continuation);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                }, new C08312((Continuation<? super C08312>) null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        }, new C08312((Continuation<? super C08312>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
