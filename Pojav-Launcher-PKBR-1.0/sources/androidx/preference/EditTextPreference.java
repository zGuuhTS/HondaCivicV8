...
public class EditTextPreference extends DialogPreference {
    ...
    public EditTextPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0100R.styleable.EditTextPreference, defStyleAttr, defStyleRes);
        if (TypedArrayUtils.getBoolean(a, C0100R.styleable.EditTextPreference_useSimpleSummaryProvider, C0100R.styleable.EditTextPreference_useSimpleSummaryProvider, false)) {
    ...
    public EditTextPreference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, C0100R.attr.editTextPreferenceStyle, 16842898));
    }
