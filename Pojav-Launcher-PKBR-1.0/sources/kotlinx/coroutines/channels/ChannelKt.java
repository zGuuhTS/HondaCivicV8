...
public final class ChannelKt {
    ...
    public static final <T> Object m1560onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            action.invoke(ChannelResult.m1566exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onClosed-WpGqRn0  reason: not valid java name */
    public static final <T> Object m1559onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> action) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            action.invoke(ChannelResult.m1566exceptionOrNullimpl($this$onClosed));
        }
