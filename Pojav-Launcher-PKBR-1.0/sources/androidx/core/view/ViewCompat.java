...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0057R.C0059id.accessibility_custom_action_0, C0057R.C0059id.accessibility_custom_action_1, C0057R.C0059id.accessibility_custom_action_2, C0057R.C0059id.accessibility_custom_action_3, C0057R.C0059id.accessibility_custom_action_4, C0057R.C0059id.accessibility_custom_action_5, C0057R.C0059id.accessibility_custom_action_6, C0057R.C0059id.accessibility_custom_action_7, C0057R.C0059id.accessibility_custom_action_8, C0057R.C0059id.accessibility_custom_action_9, C0057R.C0059id.accessibility_custom_action_10, C0057R.C0059id.accessibility_custom_action_11, C0057R.C0059id.accessibility_custom_action_12, C0057R.C0059id.accessibility_custom_action_13, C0057R.C0059id.accessibility_custom_action_14, C0057R.C0059id.accessibility_custom_action_15, C0057R.C0059id.accessibility_custom_action_16, C0057R.C0059id.accessibility_custom_action_17, C0057R.C0059id.accessibility_custom_action_18, C0057R.C0059id.accessibility_custom_action_19, C0057R.C0059id.accessibility_custom_action_20, C0057R.C0059id.accessibility_custom_action_21, C0057R.C0059id.accessibility_custom_action_22, C0057R.C0059id.accessibility_custom_action_23, C0057R.C0059id.accessibility_custom_action_24, C0057R.C0059id.accessibility_custom_action_25, C0057R.C0059id.accessibility_custom_action_26, C0057R.C0059id.accessibility_custom_action_27, C0057R.C0059id.accessibility_custom_action_28, C0057R.C0059id.accessibility_custom_action_29, C0057R.C0059id.accessibility_custom_action_30, C0057R.C0059id.accessibility_custom_action_31};
    ...
    public static void postInvalidateOnAnimation(View view, int left, int top2, int right, int bottom) {
        if (Build.VERSION.SDK_INT >= 16) {
            view.postInvalidateOnAnimation(left, top2, right, bottom);
        } else {
            view.postInvalidate(left, top2, right, bottom);
        }
    }
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0057R.C0059id.tag_accessibility_actions);
        if (actions != null) {
            return actions;
        }
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
        view.setTag(C0057R.C0059id.tag_accessibility_actions, actions2);
        return actions2;
    }
    ...
    public static void setPaddingRelative(View view, int start, int top2, int end, int bottom) {
        if (Build.VERSION.SDK_INT >= 17) {
            view.setPaddingRelative(start, top2, end, bottom);
        } else {
            view.setPadding(start, top2, end, bottom);
        }
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] mimeTypes, OnReceiveContentListener listener) {
        ...
        view.setTag(C0057R.C0059id.tag_on_receive_content_mime_types, mimeTypes2);
        view.setTag(C0057R.C0059id.tag_on_receive_content_listener, listener);
    }

    public static String[] getOnReceiveContentMimeTypes(View view) {
        return (String[]) view.getTag(C0057R.C0059id.tag_on_receive_content_mime_types);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat payload) {
        ...
        OnReceiveContentListener listener = (OnReceiveContentListener) view.getTag(C0057R.C0059id.tag_on_receive_content_listener);
        if (listener == null) {
    ...
    static class CompatImplApi28 {
        ...
        static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0057R.C0059id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(C0057R.C0059id.tag_unhandled_key_listeners, viewListeners);
            }
    ...
    public static void addOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0057R.C0059id.tag_unhandled_key_listeners);
        if (viewListeners == null) {
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m12at(root).preDispatch(evt);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m12at(root).dispatch(root, evt);
    }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0057R.C0059id.tag_screen_reader_focusable, Boolean.class, 28) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0057R.C0059id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0057R.C0059id.tag_state_description, CharSequence.class, 64, 30) {
            /* access modifiers changed from: package-private */
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0057R.C0059id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: package-private */
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m12at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0057R.C0059id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
            root.setTag(C0057R.C0059id.tag_unhandled_key_event_manager, manager2);
            return manager2;
        }
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View v, final OnApplyWindowInsetsListener listener) {
            if (Build.VERSION.SDK_INT < 30) {
                v.setTag(C0057R.C0059id.tag_on_apply_window_listener, listener);
            }
            if (listener == null) {
                v.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) v.getTag(C0057R.C0059id.tag_window_insets_animation_callback));
            } else {
        ...
        static void callCompatInsetAnimationCallback(WindowInsets insets, View v) {
            View.OnApplyWindowInsetsListener insetsAnimationCallback = (View.OnApplyWindowInsetsListener) v.getTag(C0057R.C0059id.tag_window_insets_animation_callback);
