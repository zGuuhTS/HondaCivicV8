...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
        ...
        int top2 = Math.round(bounds.top);
        ...
        copy.measure(View.MeasureSpec.makeMeasureSpec(right - left, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(bottom - top2, BasicMeasure.EXACTLY));
        copy.layout(left, top2, right, bottom);
        return copy;
    }
