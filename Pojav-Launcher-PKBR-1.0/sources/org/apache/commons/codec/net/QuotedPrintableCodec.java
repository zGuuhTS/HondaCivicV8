...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
    ...
    /* renamed from: CR */
    private static final byte f135CR = 13;
    private static final byte ESCAPE_CHAR = 61;

    /* renamed from: LF */
    private static final byte f136LF = 10;
    ...
    public QuotedPrintableCodec(boolean strict2) {
        this(StandardCharsets.UTF_8, strict2);
    }
    ...
    public static final byte[] encodeQuotedPrintable(BitSet printable, byte[] bytes, boolean strict2) {
        ...
        if (strict2) {
            ...
            if (pos + encodeByte(b2, !printable.get(b2) || (isWhitespace(b2) && pos > 68), buffer) > 71) {
                buffer.write(61);
                buffer.write(13);
                buffer.write(10);
            }
            ...
            while (i2 < bytes.length) {
                ...
                encodeByte(b3, !printable.get(b3) || (i2 > bytes.length + -2 && isWhitespace(b3)), buffer);
                i2++;
            }
        } else {
