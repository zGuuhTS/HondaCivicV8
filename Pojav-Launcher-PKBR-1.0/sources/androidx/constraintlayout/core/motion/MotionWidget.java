...
public class MotionWidget implements TypedValues {
    ...
    public String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f211top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
    ...
    public int getTop() {
        return this.widgetFrame.f211top;
    }
    ...
    public int getHeight() {
        return this.widgetFrame.bottom - this.widgetFrame.f211top;
    }
