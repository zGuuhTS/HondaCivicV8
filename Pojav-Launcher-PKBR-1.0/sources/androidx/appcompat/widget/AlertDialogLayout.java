...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0042R.C0044id.topPanel) {
                    topPanel = child;
                } else if (id == C0042R.C0044id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0042R.C0044id.contentPanel && id != C0042R.C0044id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
    ...
    public void onLayout(boolean changed, int left, int top2, int right, int bottom) {
        ...
        switch (majorGravity) {
            case 16:
                childTop = getPaddingTop() + (((bottom - top2) - totalLength) / 2);
                break;
            case 80:
                childTop = ((getPaddingTop() + bottom) - top2) - totalLength;
                break;
            default:
