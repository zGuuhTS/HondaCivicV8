...
public class PriorityGoalRow extends ArrayRow {
    ...
    private final void addToGoal(SolverVariable variable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i4 - 1].f32id > variable.f32id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() {
                public int compare(SolverVariable variable1, SolverVariable variable2) {
                    return variable1.f32id - variable2.f32id;
                }
            });
    ...
    public String toString() {
        String result = BuildConfig.FLAVOR + " goal -> (" + this.constantValue + ") : ";
        for (int i = 0; i < this.numGoals; i++) {
