    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        if (this.mOrientation == 1) {
            ...
            if (layoutState2.mLayoutDirection == -1) {
                ...
                left = left2;
                top2 = layoutState2.mOffset - layoutChunkResult.mConsumed;
            } else {
                int top3 = layoutState2.mOffset;
                right = right2;
            ...
            int top4 = getPaddingTop();
            int bottom2 = this.mOrientationHelper.getDecoratedMeasurementInOther(view) + top4;
            if (layoutState2.mLayoutDirection == -1) {
                bottom = bottom2;
        ...
        layoutDecoratedWithMargins(view, left, top2, right, bottom);
