...
public class Explode extends Visibility {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        int left = iArr[0];
        int top2 = iArr[1];
        transitionValues.values.put(PROPNAME_SCREEN_BOUNDS, new Rect(left, top2, view.getWidth() + left, view.getHeight() + top2));
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        float endX = startX;
        float endY = startY;
        int[] interruptedPosition = (int[]) transitionValues.view.getTag(C0114R.C0116id.transition_position);
