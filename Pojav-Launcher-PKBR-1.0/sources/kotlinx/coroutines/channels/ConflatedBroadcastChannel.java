...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    @Metadata(mo11814d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, mo11815d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, mo11816k = 1, mo11817mv = {1, 5, 1}, mo11819xi = 48)
    /* compiled from: ConflatedBroadcastChannel.kt */
    ...
    public Object m1578trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it == null) {
            return ChannelResult.Companion.m1577successJP2dKIU(Unit.INSTANCE);
        }
        return ChannelResult.Companion.m1575closedJP2dKIU(it.getSendException());
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v0, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v2, resolved type: kotlinx.coroutines.channels.ConflatedBroadcastChannel$Closed} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v7, resolved type: kotlinx.coroutines.channels.ConflatedBroadcastChannel$State} */
    ...
    private final kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed offerInternal(E r14) {
        ...
        L_0x000c:
            ...
            r3 = 0
        L_0x000f:
            java.lang.Object r4 = r0._state     // Catch:{ all -> 0x0063 }
            r5 = 0
            boolean r6 = r4 instanceof kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed     // Catch:{ all -> 0x0063 }
            if (r6 == 0) goto L_0x001e
            r2 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Closed r2 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed) r2     // Catch:{ all -> 0x0063 }
        L_0x001b:
            r13._updating = r1
            return r2
        L_0x001e:
            boolean r6 = r4 instanceof kotlinx.coroutines.channels.ConflatedBroadcastChannel.State     // Catch:{ all -> 0x0063 }
            if (r6 == 0) goto L_0x0051
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r6 = new kotlinx.coroutines.channels.ConflatedBroadcastChannel$State     // Catch:{ all -> 0x0063 }
            r7 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r7 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.State) r7     // Catch:{ all -> 0x0063 }
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Subscriber<E>[] r7 = r7.subscribers     // Catch:{ all -> 0x0063 }
            r6.<init>(r14, r7)     // Catch:{ all -> 0x0063 }
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = _state$FU     // Catch:{ all -> 0x0063 }
            boolean r7 = r7.compareAndSet(r13, r4, r6)     // Catch:{ all -> 0x0063 }
            if (r7 == 0) goto L_0x004e
            r0 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r0 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.State) r0     // Catch:{ all -> 0x0063 }
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Subscriber<E>[] r0 = r0.subscribers     // Catch:{ all -> 0x0063 }
            if (r0 != 0) goto L_0x003c
            goto L_0x004c
        L_0x003c:
            r7 = 0
            int r8 = r0.length     // Catch:{ all -> 0x0063 }
            r9 = r1
        L_0x003f:
            if (r9 >= r8) goto L_0x004b
            r10 = r0[r9]     // Catch:{ all -> 0x0063 }
            r11 = r10
            r12 = 0
            r11.offerInternal(r14)     // Catch:{ all -> 0x0063 }
            int r9 = r9 + 1
            goto L_0x003f
        L_0x004b:
        L_0x004c:
        ...
        L_0x0051:
            ...
            java.lang.String r0 = kotlin.jvm.internal.Intrinsics.stringPlus(r0, r4)     // Catch:{ all -> 0x0063 }
            java.lang.IllegalStateException r2 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0063 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x0063 }
            r2.<init>(r0)     // Catch:{ all -> 0x0063 }
            java.lang.Throwable r2 = (java.lang.Throwable) r2     // Catch:{ all -> 0x0063 }
