...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0042R.attr.actionBarSize, 16842841};
    ...
    private boolean applyInsets(View view, Rect insets, boolean left, boolean top2, boolean bottom, boolean right) {
        ...
        if (top2 && lp.topMargin != insets.top) {
            changed = true;
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!this.mOverlayMode && !stable) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m5of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + topInset, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
        } else {
    ...
    public void draw(Canvas c) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            if (this.mActionBarTop.getVisibility() == 0) {
                top2 = (int) (((float) this.mActionBarTop.getBottom()) + this.mActionBarTop.getTranslationY() + 0.5f);
            } else {
                top2 = 0;
            }
            this.mWindowContentOverlay.setBounds(0, top2, getWidth(), this.mWindowContentOverlay.getIntrinsicHeight() + top2);
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0042R.C0044id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0042R.C0044id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0042R.C0044id.action_bar));
        }
    }
