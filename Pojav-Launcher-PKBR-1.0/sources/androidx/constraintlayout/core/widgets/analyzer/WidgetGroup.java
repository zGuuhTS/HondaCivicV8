...
public class WidgetGroup {
    ...
    public String toString() {
        String ret = getOrientationString() + " [" + this.f66id + "] <";
    ...
    private int solverMeasure(LinearSystem system, ArrayList<ConstraintWidget> widgets2, int orientation2) {
        ...
        int top2 = system.getObjectVariableValue(container.mTop);
    ...
    class MeasureResult {
        ...
        public MeasureResult(ConstraintWidget widget, LinearSystem system, int orientation2) {
            ...
            this.f212top = system.getObjectVariableValue(widget.mTop);
        ...
        public void apply() {
            ...
            if (widget != null) {
                widget.setFinalFrame(this.left, this.f212top, this.right, this.bottom, this.baseline, this.orientation);
            }
        }
    }
}
