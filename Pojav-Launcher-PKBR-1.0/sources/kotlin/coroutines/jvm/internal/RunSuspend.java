...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1271getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result2) {
        synchronized (this) {
            this.result = Result.m63boximpl(result2);
