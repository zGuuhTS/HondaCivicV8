...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    public Object flowCollect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        if (!DebugKt.getASSERTIONS_ENABLED() || (collector instanceof SendingCollector) != 0) {
            Object flowScope = FlowCoroutineKt.flowScope(new ChannelFlowTransformLatest$flowCollect$3(this, collector, (Continuation<? super ChannelFlowTransformLatest$flowCollect$3>) null), $completion);
