...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f214top;
    }
    ...
    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(int left, int top2, int right, int bottom) {
        return new Builder(this).setSystemWindowInsets(Insets.m5of(left, top2, right, bottom)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect systemWindowInsets) {
        return new Builder(this).setSystemWindowInsets(Insets.m6of(systemWindowInsets)).build();
    }

    @Deprecated
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f214top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f214top, insets.right, insets.bottom);
    }

    public WindowInsetsCompat inset(int left, int top2, int right, int bottom) {
        return this.mImpl.inset(left, top2, right, bottom);
    }
    ...
    private static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int type, boolean ignoreVisibility) {
            ...
            switch (type) {
                case 1:
                    if (ignoreVisibility) {
                        return Insets.m5of(0, Math.max(getRootStableInsets().f214top, getSystemWindowInsets().f214top), 0, 0);
                    }
                    return Insets.m5of(0, getSystemWindowInsets().f214top, 0, 0);
                case 2:
                    if (ignoreVisibility) {
                        Insets rootStable = getRootStableInsets();
                        Insets stable = getStableInsets();
                        return Insets.m5of(Math.max(rootStable.left, stable.left), 0, Math.max(rootStable.right, stable.right), Math.max(rootStable.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m5of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable2.bottom) {
                        return Insets.m5of(0, 0, 0, systemWindow2.bottom);
                    }
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m5of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        public WindowInsetsCompat inset(int left, int top2, int right, int bottom) {
            ...
            b.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), left, top2, right, bottom));
            b.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), left, top2, right, bottom));
            return b.build();
        }
        ...
        private Insets getVisibleInsets(View rootView) {
            if (Build.VERSION.SDK_INT < 30) {
                ...
                try {
                    ...
                    if (visibleRect != null) {
                        return Insets.m6of(visibleRect);
                    }
                    return null;
    ...
    private static class Impl29 extends Impl28 {
        ...
        /* access modifiers changed from: package-private */
        public WindowInsetsCompat inset(int left, int top2, int right, int bottom) {
            return WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets.inset(left, top2, right, bottom));
        }
    ...
    static Insets insetInsets(Insets insets, int left, int top2, int right, int bottom) {
        int newLeft = Math.max(0, insets.left - left);
        int newTop = Math.max(0, insets.f214top - top2);
        int newRight = Math.max(0, insets.right - right);
        int newBottom = Math.max(0, insets.bottom - bottom);
        if (newLeft == left && newTop == top2 && newRight == right && newBottom == bottom) {
            return insets;
        }
        return Insets.m5of(newLeft, newTop, newRight, newBottom);
    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f214top, insets.right, insets.bottom);
            }
        }
            ...
            try {
                ...
                if (attachInfo != null) {
                    ...
                    if (!(stableInsets == null || visibleInsets == null)) {
                        WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m6of(stableInsets)).setSystemWindowInsets(Insets.m6of(visibleInsets)).build();
