...
final class ExpandButton extends Preference {
    ...
    private void initLayout() {
        setLayoutResource(C0100R.C0103layout.expand_button);
        setIcon(C0100R.C0101drawable.ic_arrow_down_24dp);
        setTitle(C0100R.string.expand_button_title);
        setOrder(999);
    }
        ...
        for (Preference preference : collapsedPreferences) {
            ...
            if (parents.contains(preference.getParent())) {
                ...
                if (summary == null) {
                    ...
                    summary = getContext().getString(C0100R.string.summary_collapsed_preference_list, new Object[]{summary, title});
                }
            }
        }
        setSummary(summary);
