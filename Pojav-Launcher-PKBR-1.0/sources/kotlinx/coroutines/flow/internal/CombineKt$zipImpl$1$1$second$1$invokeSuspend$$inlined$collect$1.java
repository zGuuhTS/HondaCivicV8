...
public final class CombineKt$zipImpl$1$1$second$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<T2> {
    ...
    public Object emit(T2 value, Continuation<? super Unit> $completion) {
        Object value2 = value;
        Continuation<? super Unit> continuation = $completion;
        Object send = this.$$this$produce$inlined.getChannel().send(value2 == null ? NullSurrogateKt.NULL : value2, $completion);
