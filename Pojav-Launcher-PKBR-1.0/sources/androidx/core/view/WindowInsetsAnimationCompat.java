...
public final class WindowInsetsAnimationCompat {
    ...
    public static final class BoundsCompat {
        ...
        public BoundsCompat inset(Insets insets) {
            return new BoundsCompat(WindowInsetsCompat.insetInsets(this.mLowerBound, insets.left, insets.f214top, insets.right, insets.bottom), WindowInsetsCompat.insetInsets(this.mUpperBound, insets.left, insets.f214top, insets.right, insets.bottom));
        }
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object userListener = view.getTag(C0057R.C0059id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0057R.C0059id.tag_window_insets_animation_callback, (Object) null);
            ...
            view.setTag(C0057R.C0059id.tag_window_insets_animation_callback, proxyListener);
            if (userListener == null) {
        ...
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat target, WindowInsetsCompat starting, float fraction, int typeMask) {
            ...
            for (int i = 1; i <= 256; i <<= 1) {
                if ((typeMask & i) == 0) {
                    ...
                    builder.setInsets(i, WindowInsetsCompat.insetInsets(targetInsets, (int) (((double) (((float) (targetInsets.left - startingInsets.left)) * (1.0f - fraction))) + 0.5d), (int) (((double) (((float) (targetInsets.f214top - startingInsets.f214top)) * (1.0f - fraction))) + 0.5d), (int) (((double) (((float) (targetInsets.right - startingInsets.right)) * (1.0f - fraction))) + 0.5d), (int) (((double) (((float) (targetInsets.bottom - startingInsets.bottom)) * (1.0f - fraction))) + 0.5d)));
                }
            }
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
                ...
                C03781 r9 = r0;
                final View view2 = v;
                C03781 r0 = new ValueAnimator.AnimatorUpdateListener() {
        ...
        static WindowInsets forwardToViewIfNeeded(View v, WindowInsets insets) {
            if (v.getTag(C0057R.C0059id.tag_on_apply_window_listener) != null) {
                return insets;
            }
        ...
        static Callback getCallback(View child) {
            Object listener = child.getTag(C0057R.C0059id.tag_window_insets_animation_callback);
