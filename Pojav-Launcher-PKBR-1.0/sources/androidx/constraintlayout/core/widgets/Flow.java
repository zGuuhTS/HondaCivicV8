...
public class Flow extends VirtualLayout {
    ...
    private class WidgetsList {
        ...
        public WidgetsList(int orientation, ConstraintAnchor left, ConstraintAnchor top2, ConstraintAnchor right, ConstraintAnchor bottom, int max) {
        ...
        public void setup(int orientation, ConstraintAnchor left, ConstraintAnchor top2, ConstraintAnchor right, ConstraintAnchor bottom, int paddingLeft, int paddingTop, int paddingRight, int paddingBottom, int max) {
            this.mOrientation = orientation;
            this.mLeft = left;
            this.mTop = top2;
            this.mRight = right;
    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (i3 != 0) {
            ...
            ConstraintAnchor top2 = this.mTop;
            ...
            while (i10 < listCount) {
                ...
                if (orientation == 0) {
                    ...
                    ConstraintAnchor constraintAnchor = top2;
                    current2.setup(orientation, left3, top2, right, bottom, paddingLeft, paddingTop2, paddingRight2, paddingBottom2, max);
                    ConstraintAnchor top3 = current2.biggest.mBottom;
                    paddingTop2 = 0;
                    ...
                    current2.setup(orientation, left3, top4, right, bottom, paddingLeft, paddingTop2, paddingRight2, paddingBottom2, max);
            ...
            ConstraintAnchor constraintAnchor2 = top2;
            measured[0] = maxWidth;
