...
public final class FlowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<T> {
    ...
    public Object emit(T value, Continuation<? super Unit> $completion) {
        ...
        Object invoke = this.$transform$inlined.invoke(this.$$this$flow$inlined, value, $completion);
    ...
    public Object emit$$forInline(Object value, Continuation $completion) {
        ...
        this.$transform$inlined.invoke(this.$$this$flow$inlined, value, $completion);
