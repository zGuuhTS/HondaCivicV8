...
public class WidgetFrame {
    ...
    public int height() {
        return Math.max(0, this.bottom - this.f211top);
    }
    ...
    public static void interpolate(int parentWidth, int parentHeight, WidgetFrame frame, WidgetFrame start, WidgetFrame end, Transition transition, float progress) {
        ...
        int startY2 = widgetFrame2.f211top;
        int endX3 = widgetFrame3.left;
        int endY = widgetFrame3.f211top;
        int startWidth2 = widgetFrame2.right - widgetFrame2.left;
        int startHeight2 = widgetFrame2.bottom - widgetFrame2.f211top;
        int endWidth = widgetFrame3.right - widgetFrame3.left;
        int startWidth3 = startWidth2;
        int endHeight2 = widgetFrame3.bottom - widgetFrame3.f211top;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (firstPosition != null) {
                int i5 = frameNumber;
                startX4 = (int) (firstPosition.f54x * ((float) i));
                endX = endX3;
                startX2 = parentHeight;
                interpolateStartFrame2 = firstPosition.frame;
                startY3 = (int) (firstPosition.f55y * ((float) startX2));
            } else {
                startX2 = parentHeight;
                int i6 = frameNumber;
                endX = endX3;
            ...
            if (lastPosition != null) {
                ...
                endX2 = (int) (lastPosition.f54x * ((float) i));
                endY = (int) (lastPosition.f55y * ((float) startX2));
    ...
    public WidgetFrame update() {
        ...
        if (constraintWidget != null) {
            ...
            this.f211top = this.widget.getTop();
