...
public final class ProduceKt {
    ...
    public static final java.lang.Object awaitClose(kotlinx.coroutines.channels.ProducerScope<?> r8, kotlin.jvm.functions.Function0 r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L_0x0051:
            ...
            r2 = 0
            r10.L$0 = r8     // Catch:{ all -> 0x003a }
            r10.L$1 = r9     // Catch:{ all -> 0x003a }
            r10.label = r3     // Catch:{ all -> 0x003a }
            r4 = r10
            ...
            r4 = r3
            kotlinx.coroutines.CancellableContinuation r4 = (kotlinx.coroutines.CancellableContinuation) r4     // Catch:{ all -> 0x003a }
            r6 = 0
            kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1 r7 = new kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1     // Catch:{ all -> 0x003a }
            r7.<init>(r4)     // Catch:{ all -> 0x003a }
            kotlin.jvm.functions.Function1 r7 = (kotlin.jvm.functions.Function1) r7     // Catch:{ all -> 0x003a }
            r8.invokeOnClose(r7)     // Catch:{ all -> 0x003a }
            java.lang.Object r8 = r3.getResult()     // Catch:{ all -> 0x003a }
