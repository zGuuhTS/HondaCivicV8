...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, "position") {
        public void set(View view, PointF topLeft) {
            ...
            int top2 = Math.round(topLeft.y);
            ViewUtils.setLeftTopRightBottom(view, left, top2, view.getWidth() + left, view.getHeight() + top2);
        }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (transitionValues == null) {
            ...
            if (startParent == null) {
                    ...
                    if (numChanges > 0) {
                        ...
                        if (!this.mResizeClip) {
                            ...
                            if (!startClip.equals(endClip)) {
                                ...
                                C05838 r0 = new AnimatorListenerAdapter() {
                ...
                C057610 r02 = new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animation) {
